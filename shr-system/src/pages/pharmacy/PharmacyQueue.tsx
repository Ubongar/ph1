    ...
    <div className="p-4 sm:p-6">
      ...
      {view === 'kanban' ? (
        ...
        <div className="bg-white rounded-xl border border-gray-200">
          <div className="p-4 border-b flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:gap-4">
            ...
            <button onClick={() => toast('Queue exported (simulated)', 'info')} className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm">
